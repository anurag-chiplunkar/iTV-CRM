# Generated by Django 3.2.11 on 2022-02-01 07:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pri_designation', models.CharField(max_length=50)),
                ...
                ('sec_designation', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('sec_landline', models.CharField(max_length=15)),
                ('sec_flatno', models.CharField(max_length=10)),
                ('sec_streetname', models.CharField(max_length=100)),
                ('sec_landmark', models.CharField(max_length=100)),
                ('sec_city', models.CharField(max_length=50)),
                ('sec_pincode', models.CharField(max_length=10)),
