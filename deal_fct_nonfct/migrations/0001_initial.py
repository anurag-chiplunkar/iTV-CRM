# Generated by Django 3.2.6 on 2022-03-09 17:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DealFct',
            fields=[
                ('dealid_fct', models.CharField(default='default',
                ...
                ('eff_rate1', models.DecimalField(blank=True,
                 decimal_places=2, max_digits=12, null=True)),
                ('eff_rate2', models.DecimalField(blank=True,
                 decimal_places=2, max_digits=12, null=True)),
                ('eff_rate3', models.DecimalField(blank=True,
                 decimal_places=2, max_digits=12, null=True)),
                ('rev1', models.DecimalField(blank=True,
                 decimal_places=2, max_digits=12, null=True)),
                ('rev2', models.DecimalField(blank=True,
                 decimal_places=2, max_digits=12, null=True)),
                ('rev3', models.DecimalField(blank=True,
                 decimal_places=2, max_digits=12, null=True)),
                ('total_rev', models.DecimalField(blank=True,
                 decimal_places=2, max_digits=12, null=True)),
                ('base_rate1', models.IntegerField(
                    blank=True, default='0', null=True)),
                ('base_rate2', models.IntegerField(
                    blank=True, default='0', null=True)),
                ('base_rate3', models.IntegerField(
                    blank=True, default='0', null=True)),
        ...
        migrations.CreateModel(
            name='Fct_deal',
            fields=[
                ('dealid_fct_ref', models.CharField(default='default',
                 max_length=100, primary_key=True, serialize=False)),
                ('chan', models.CharField(blank=True, max_length=1000, null=True)),
                ('dis', models.CharField(blank=True, max_length=1000, null=True)),
                ('band1', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fct_total_rev', models.DecimalField(
                    blank=True, decimal_places=2, max_digits=12, null=True)),
                ('agency_contact_ref', models.ForeignKey(default='default',
                 on_delete=django.db.models.deletion.CASCADE, to='agency_client.agencycontact')),
                ('agency_name_ref', models.ForeignKey(default='default',
                 on_delete=django.db.models.deletion.CASCADE, to='agency_client.agencydetail')),
                ('brand_name_ref', models.ForeignKey(default='default', on_delete=django.db.models.deletion.CASCADE,
                 related_name='brandfct', to='agency_client.customername')),
                ('client_contact_ref', models.ForeignKey(default='default',
                 on_delete=django.db.models.deletion.CASCADE, to='agency_client.customercontact')),
                ('client_name_ref', models.ForeignKey(default='default', on_delete=django.db.models.deletion.CASCADE,
                 related_name='clientfct', to='agency_client.customername')),
            ],
        ),
    ]
